 ...
 * @author clockett
 */
public class DataMulti extends DataPacket{


    /** Channel samples were taken from. */
    ...
    {   // Set type name
        this.typeName = "EHZ"; //just for default
    }
     ...
     *         ChannelBuffer.
     */
    public DataMulti(String networkID, DefaultHeader header,
        ...
        try {
            ...
            // Get the channel.
            channel = buffer.readUnsignedShort();
            ...
            //change 11/16/11 to make compatable with Earth worm system affter
            //meeting with Seth Moran
            Double diff = ((double) samples - 1) / (double) sampleRate;
            //Double diff = ((double) samples) / (double) sampleRate;
    ...
    public void sendOut() {
        ...
        SendMulti.sendToEarthworm(this);
    }

    /**
     * @return the channel the samples were taken from
     */
