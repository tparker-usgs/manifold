...
/**
 * Defines the One second scan data type.
 * <pre> <code>
 * Definition:
 * timeStamp  18 bytes ascii string       start timeString in YYYYMMDDHHmmSS.sss
 * data       8, 2 byte unsigned shorts   
 * </code> </pre>
 *
 */
public class DataOneSecondScan extends DataPacket {
    ...
    private final int DATA_BLOCKS = 8;
     ...
     *         ChannelBuffer.
     */
    public DataOneSecondScan(String networkID, DefaultHeader header,
    ...
    public void sendOut() {
        ...
        SendOneSecondScan.sendToQueue(this);
    }
